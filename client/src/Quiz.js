    ...
    renderScore() {
        ...
        return (<div className="card animated bounceIn">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">Игрок {this.state.player1.name} набрал всего очков: {this.state.player1Score}<br />
                    Игрок {this.state.player2.name} набрал всего очков: {this.state.player2Score}</p>
